...
<html lang="en">
  <head>
    ...
    <title>Pizzahut | Starters</title>
    <link rel="stylesheet" href="../css/pages/deals.css" />
		<link rel="stylesheet" href="../css/pages/starters.css">
    ...
    <nav class="w-100 bg-white sticky-top">
      ...
      >
        <ul class="left fw-bold d-flex align-items-center m-0">
          ...
          <li class=" d-flex align-items-center">
            <a class="active d-flex align-items-center p-2" href="/starters">starters</a>
          </li>
          <li class="d-flex align-items-center">
        ...
        <div class="row pt-5 pb-3 products-scroll boxes gap-4 align-items-start">
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                ...
                src="../assets/starters/starters-1.png"
                alt=""
              />
            </div>
            <div class="content p-3 d-flex flex-column justify-content-between">
              <h3 class="fs-5">Spicy Kriss Cut Fries</h3>
              <p class="mb-4">
                Oven baked kriss cut fries with Tabasco sprin
              </p>
              <div
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                class="img-fluid w-100"
                src="../assets/starters/starters-2.png"
                alt=""
              />
            </div>
            <div class="content p-3 d-flex flex-column justify-content-between">
              <h3 class="fs-5">Fire Wings</h3>
              <p class="mb-4">
                Served with our special BBQ sauce (Spicy Hot)
              </p>
              <div
                class="cost-add d-flex justify-content-between align-items-center"
              >
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                class="img-fluid w-100"
                src="../assets/starters/starters-3.png"
                alt=""
              />
            </div>
            <div class="content p-4">
              <h3 class="fs-5">Potato Wedges</h3>
              <p class="mb-4">
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                class="img-fluid w-100"
                src="../assets/starters/starters-4.png"
                alt=""
              />
            </div>
            <div class="content p-4">
              <h3 class="fs-5">Buffalo Wings</h3>
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                class="img-fluid w-100"
                src="../assets/starters/starters-5.png"
                alt=""
              />
            </div>
            <div class="content p-4">
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                class="img-fluid w-100"
                src="../assets/starters/starters-6.png"
                alt=""
              />
            </div>
            <div class="content p-4">
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                class="img-fluid w-100"
                src="../assets/starters/starters-7.png"
                alt=""
              />
            </div>
            <div class="content p-4">
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                class="img-fluid w-100"
                src="../assets/starters/starters-8.png"
                alt=""
              />
            </div>
            <div class="content p-4">
