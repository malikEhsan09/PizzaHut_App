  ...
  <body>
    ...
    <nav class="w-100 bg-white sticky-top">
      ...
      >
        <ul class="left fw-bold d-flex align-items-center m-0">
          ...
          <li class="d-flex align-items-center">
            <a class="d-flex align-items-center p-2" href="/salads"
              >saladas</a
            >
          </li>
          <li
    ...
    <section class="pb-5">
      <div class="container ps-4 pe-4 d-flex align-items-start">
        <div
          class="row flex-fill pt-5 pb-3 products-scroll boxes gap-4 align-items-start"
        >
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image text-center">
              <img
                class="img-fluid"
                src="../assets/drinks/pepsi.jpg"
                alt=""
              />
            </div>
            <div class="content p-3 d-flex flex-column justify-content-between">
              <h3 class="fs-5">Pepsi</h3>
              <div
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image text-center">
              <img
                class="img-fluid"
                src="../assets/drinks/Aquafina-newpwa1_new2.jpg"
                alt=""
              />
            </div>
            <div class="content p-3 d-flex flex-column justify-content-between">
              <h3 class="fs-5">Aquafina</h3>
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image text-center">
              <img
                class="img-fluid"
                src="../assets/drinks/Diet-Pepsi_large-new2.jfif"
                alt=""
              />
            </div>
            <div class="content p-4">
              <h3 class="fs-5">Diet Pepsi</h3>
              <div
                class="cost-add d-flex justify-content-between align-items-center"
              >
                <div class="mon">pkr 50.00</div>
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image text-center">
              <img
                class="img-fluid"
                src="../assets/drinks/Mirinda-newpwa1_new2.jpg"
                alt=""
              />
            </div>
            <div class="content p-4">
              <h3 class="fs-5">Mirinda</h3>
              <div
                class="cost-add d-flex justify-content-between align-items-center"
              >
                <div class="mon">pkr 50.00</div>
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image text-center">
              <img
                class="img-fluid"
                src="../assets/drinks/7up-newpwa1-new2.jpg"
                alt=""
              />
            </div>
            <div class="content p-4">
              <h3 class="fs-5">7UP</h3>
              <div
                class="cost-add d-flex justify-content-between align-items-center"
              >
                <div class="mon">pkr 50.00</div>
