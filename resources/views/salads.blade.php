  ...
  <body>
    ...
    <nav class="w-100 bg-white sticky-top">
      ...
      <div class="top pt-2 pb-2 fw-bold d-flex align-items-center">
        ...
        <div id="lang-change" class="p-lg-2 rounded">
          <a href="#">English</a>
        </div>
      </div>
      <div
      ...
      >
        <ul class="left fw-bold d-flex align-items-center m-0">
          ...
          <li class="d-flex align-items-center">
            <a class="active d-flex align-items-center p-2" href="/salads"
              >saladas</a
            >
          </li>
          <li
    ...
    <section class="pb-5">
      <div class="container ps-4 pe-4 d-flex align-items-start">
        ...
        >
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                ...
                src="../assets/salads/175x175Salad.jpg"
                alt=""
              />
            </div>
          ...
          <div class="box col-lg-3 col-md-6 bg-white p-0 rounded">
            <div class="image">
              <img
                class="img-fluid w-100"
                src="../assets/salads/SupremeSalad.jpg"
                alt=""
              />
            </div>
            <div class="content p-3 d-flex flex-column justify-content-between">
        ...
        <div
          class="cart-status text-center d-none p-5 mt-5 rounded d-lg-flex flex-column gap-4 bg-white"
        >
          <div class="image">
    ...
    <!-- END Main Section -->
    <script src="{{ asset('js/salads.js') }}"></script>
